...
class CultureQuizScreen extends StatefulWidget {
  const CultureQuizScreen({Key? key}) : super(key: key);
...
class _CultureQuizScreenState extends State<CultureQuizScreen>
  ...
  final List<Map<String, Object>> _questions = [
    {
      'question': 'Какая ценность НЕ относится к Neoflex?',
      'answers': [
        {'text': 'Клиентоцентричность', 'score': 0},
        {'text': 'Экспертиза', 'score': 0},
        {'text': 'Иерархичность', 'score': 1},
        {'text': 'Партнёрство', 'score': 0},
      ]
    },
    {
      'question': 'Как называется программа для реализации личных идей сотрудников?',
      'answers': [
        {'text': 'NeoConf', 'score': 0},
        {'text': 'NeoCharity', 'score': 0},
        {'text': 'NeoTime', 'score': 1},
      ]
    },
    {
      'question': 'Что из перечисленного является благотворительной инициативой Neoflex?',
      'answers': [
        {'text': 'NeoCharity', 'score': 1},
        {'text': 'NeoCommunity', 'score': 0},
        {'text': 'NeoSkills', 'score': 0},
      ]
    },
  ];
